# Feiglet v2 — Image Input & Full TUI Editor

Milestone goal: Extend Feiglet beyond FIGlet 2.2.5 with image-to-ASCII
...
- [ ] `2.2.3` FIGfont header from font metrics
  ...
  - **Touches:** `feiglet-rs/src/font_gen.rs`
  - **Success:** Generated `.flf` loads in Feiglet, renders identically to
...
- [ ] `2.3.2` Toolbox bar
  ...
  - **Touches:** `feiglet-rs/src/tui/toolbox.rs`
...
- [ ] `2.3.3` Canvas widget
  ...
  - **Touches:** `feiglet-rs/src/tui/canvas.rs`
...
- [ ] `2.3.4` Color palette
  ...
  - **Touches:** `feiglet-rs/src/tui/palette.rs`
...
- [ ] `2.3.5` Brush selection
  - **Goal:** Brush shape picker: square, circle, spray paint, custom
    ...
    shape in toolbox.
  - **Touches:** `feiglet-rs/src/tui/brush.rs`
...
- [ ] `2.3.6` Status bar + canvas settings
  ...
  - **Touches:** `feiglet-rs/src/tui/status.rs`
...
- [ ] `2.4.1` Brush tool
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/brush.rs`
...
- [ ] `2.4.2` Eraser tool
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/eraser.rs`
...
- [ ] `2.4.3` Line tool
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/line.rs`
...
- [ ] `2.4.4` Fill / flood fill tool
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/fill.rs`
...
- [ ] `2.4.5` Selection tools: marquee, lasso, circle, polygon
  - **Goal:** Marquee: click-drag rectangle selection. Lasso: freehand
    ...
    cut, deleted.
  - **Touches:** `feiglet-rs/src/tui/tools/selection.rs`
...
- [ ] `2.4.6` Eyedropper tool
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/eyedropper.rs`
...
- [ ] `2.4.7` Spray paint brush
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/spray.rs`
...
- [ ] `2.5.1` Font mode scaffold: glyph grid overview
  ...
  - **Touches:** `feiglet-rs/src/tui/font_editor.rs`
...
- [ ] `2.6.1` Image import + canvas display
  ...
  - **Touches:** `feiglet-rs/src/tui/image_editor.rs`, `feiglet-rs/src/image_input.rs`
...
- [ ] `2.6.2` Text tool with FIGlet font overlay
  ...
  - **Touches:** `feiglet-rs/src/tui/tools/text.rs`
...
- [ ] `2.6.4` Image adjustments
  ...
  - **Touches:** `feiglet-rs/src/tui/image_editor.rs`
...
- [ ] `2.7.1` Save / Save As
  ...
  - **Touches:** `feiglet-rs/src/tui/file_ops.rs`
...
- [ ] `2.7.4` Export: PNG, TXT, GIF
  ...
  - **Touches:** `feiglet-rs/src/tui/export.rs`, `feiglet-rs/src/output.rs`
  - **Success:** Exported files match canvas appearance.
  - **Tests:** Export → re-import, verify content preserved.
  - **Difficulty:** Medium

- [ ] `2.7.5` Config file
  - **Goal:** `~/.config/feiglet/config.toml`: default font, output width,
...
- [ ] `2.7.6` Undo/redo system
  ...
  - **Touches:** `feiglet-rs/src/tui/undo.rs`
...
- [ ] `2.8.1` Layer system
  ...
  - **Touches:** `feiglet-rs/src/tui/layers.rs`
...
- [ ] `2.8.4` Export with layers
  ...
  - **Touches:** `feiglet-rs/src/tui/export.rs`
...
- [ ] `2.9.1` Frame management
  ...
  - **Touches:** `feiglet-rs/src/tui/timeline.rs`
