...
## Phase 4.1 — Layers, Blending & Compositing
...
- [ ] `4.1.5` Phase merge: release/4.1 → main
  - **Difficulty:** Low

---

## Phase 4.2 — Animation Timeline & Playback

- [x] `4.2.0` Custom ratatui widget: `AnimationTimeline`
...
- [x] `4.2.4` GIF export from timeline
...
- [x] `4.2.5` Phase merge: release/4.2 → main
  - **Difficulty:** Low

---

## Phase 4.3 — Particle Effect Creator

- [ ] `4.3.1` Particle system design
...
- [ ] `4.3.3` Particle-to-layer baking
...
- [ ] `4.3.4` Phase merge: release/4.3 → master
  - **Difficulty:** Low

---

## Phase 4.4 — Animation Exporter

- [ ] `4.4.1` Frame-by-frame terminal capture
...
- [ ] `4.4.3` ANSI escape sequence export
...
- [ ] `4.4.4` Phase merge: release/4.4 → main
  - **Difficulty:** Low

---

## Phase 4.5 — Animation Player (Standalone Widget)

- [ ] `4.5.0` Custom ratatui widget: `AnimationPlayer`
...
- [ ] `4.5.1` Terminal capture for playback
...
- [ ] `4.5.2` Raw mode playback engine
...
- [ ] `4.5.3` Player integration into TUI
...
- [ ] `4.5.4` Phase merge: release/4.5 → main
  - **Difficulty:** Low

---

## Phase 4.0-P (Priority Bugs & Polish) — TUI Startup & Interaction

> **These are pre-4.1 blockers. Fix before any Phase 4.1+ work.**

- [x] `4.0-P.1` Remove auto-load of standard font on startup *(fixed)*
...
- [x] `4.0-P.2` Fix OS Error 2 in file open dialog *(fixed)*
...
- [x] `4.0-P.3` Block mouse fall-through when dialog is open *(fixed)*
...
- [ ] `4.0-P.4` Welcome screen on startup
...
- [ ] `4.0-P.5` ZIP file browsing in file open dialog
...
## Phase 4.0-A (Architecture Audit)

- [ ] `4.0-A.1` TUI architecture deepdive vs ratatui best practices
...
- [ ] `4.0-A.2` Apply ratatui architecture fixes from audit
  - **Goal:** Implement fixes identified in `4.0-A.1`. Priority: widget
...
## Phase 4.0-V (Visual Polish & TachyonFX)

- [ ] `4.0-V.1` Evaluate TachyonFX for UI animations
...
- [ ] `4.0-V.2` Default panel theme inspired by TachyonFX aesthetic
...
- [ ] `4.0-V.3` App fade-in on launch (ratzilla-style)
...
- [ ] `4.0-V.4` New status bar redesign
...
## Phase 4.0-W (Web Target)

- [ ] `4.0-W.1` WASM / web target via Ratzilla
...
## Phase 4.0-C (Extended Charsets) — TOP PRIORITY

> Needed for font-gen, canvas work, and braille/block art modes.

- [ ] `4.0-C.1` Braille charset block
...
- [ ] `4.0-C.2` Block elements charset
...
- [ ] `4.0-C.3` Box drawing + dithered charset
  - **Goal:** Add:
...
## Phase 4.0-L (Dynamic Lighting — Future/Exploratory)

> Long-horizon research item. No implementation until v4.x. Design only for now.

- [ ] `4.0-L.1` Dynamic lighting system — initial design
...
## Phase 4.6 — Major Release

- [ ] `4.6.1` Full regression against C FIGlet 2.2.5
...
- [ ] `4.6.2` v4 major milestone RC — human sign-off
